...
let introContent: [String: [IntroParagraph]] = [
  "typeworld-l01-elements": [
    ...
    IntroParagraph(segments: [
      ...
      .word("as a"),
      .emphasis("proof"),
      .word("that the proposition"),
      .identPill("P"),
      .word("is true."),
    ]),
    IntroParagraph(segments: [
      .word("The context collectively asserts that"),
      .identPill("P"),
      .word("is a proposition and"),
      .identPill("p"),
      .word("is a proof of"),
      .identPill("P"),
      .word(". Our assumptions imply that the proposition"),
      .identPill("P"),
      .word("is true."),
    ]),
    IntroParagraph(segments: [
      .word("We know that"),
      .identPill("P"),
      .word("is true because we have assumed that"),
      .identPill("P"),
      .word("is true. So the tactic"),
      .tacticPill("assumption"),
      .word("can be used to tell Lean that"),
      .identPill("P"),
      .word("is true by assumption."),
    ]),
  ],
